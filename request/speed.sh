...
echo -e "${cor[4]} $(fun_trans "Speed Test") [EDDYJHOEL-SCRIP FLIX]"
msg -bar
...
sleep 0.6s
down_load=$(echo "$starts_test" | grep "Descarga" | awk '{print $2,$3}')
up_load=$(echo "$starts_test" | grep "Subida" | awk '{print $2,$3}')
msg -ama " $(fun_trans "Latencia"): $ping"
msg -ama " $(fun_trans "Carga"): $up_load"
