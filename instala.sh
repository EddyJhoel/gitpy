...
rm $HOME/lulseck.sh
SCPresq="aHR0cHM6Ly9yYXcuZ2l0aHVidXNlcmNvbnRlbnQuY29tL0VkZHlKaG9lbC9naXRweS9tYXN0ZXIvcmVxdWVzdA=="
SUB_DOM='base64 -d'
...
funcao_idioma () {
 echo -e " "
msg -bar2
cowsay -f eyes "BIENVENIDO A EDDYJHOEL-SCRIP 2.0" | lolcat
...
fun_ip
wget -O /usr/bin/trans https://raw.githubusercontent.com/EddyJhoel/gitpy/master/Install/trans &> /dev/null
msg -bar2
msg -ama "EDDYJHOEL-SCRIP BOOSTER"
[[ $1 = "" ]] && funcao_idioma || {
